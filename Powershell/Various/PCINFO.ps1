...
#                     hackyeah.com                      # 
#   Made PowerShell 6 (No More WMI) compatible by Ivan  #
######################################################### 
...
function CheckHost{ 
    $ping = Get-CimInstance Win32_PingStatus -filter "Address='$compname'" 
...
function GetInfo{ 
    ...
    switch ($MenuSelection){ 
        0 { #HD Serial Number 
            Get-CimInstance -computer $compname Win32_PhysicalMedia | Where-Object {$_.Tag -eq '\\.\PHYSICALDRIVE0'} | Format-Table SerialNumber
            Pause 
            CheckHost 
          } 
        ...
        1 { #PC Serial Number 
            Get-CimInstance -computer $compname Win32_BIOS | Select-Object SerialNumber | Format-List 
            Pause 
            CheckHost 
          } 
           
        2 { #PC Printer Information 
            Get-CimInstance -computer $compname Win32_Printer | Select-Object DeviceID,DriverName, PortName | Format-List 
            Pause 
            CheckHost           
          } 
           
        3 { #Current User 
            Get-CimInstance -computer $compname Win32_ComputerSystem | Format-Table @{Expression={$_.Username};Label="Current User"} 
            "" 
            #May take a very long time if on a domain with many users 
            #"All Users" 
            #"------------" 
            #Get-CimInstance -computer $compname Win32_UserAccount | foreach{$_.Caption} 
            Pause 
            CheckHost           
          } 
           
        4 { #OS Info 
            Get-CimInstance -computer $compname Win32_OperatingSystem | Format-List @{Expression={$_.Caption};Label="OS Name"},SerialNumber,OSArchitecture 
            Pause 
            CheckHost        
          } 
           
        5 { #System Info 
            Get-CimInstance -computer $compname Win32_ComputerSystem | Format-List Name,Domain,Manufacturer,Model,SystemType 
            Pause 
            CheckHost          
          }         
           
        6 { #Add/Remove Program List 
            Get-CimInstance -computer $compname Win32_Product | Sort-Object Name | Format-Table Name,Vendor,Version 
            Pause 
            CheckHost 
          } 
        ...
        7 { #Process Listx 
            ...
            Get-CimInstance -computer $compname Win32_Process | Select-Object Caption,Handle | Sort-Object Caption | Format-Table 
            Pause 
            CheckHost          
          } 
           
        8 { #Service List 
            Get-CimInstance -computer $compname Win32_Service | Select-Object Name,State,Status,StartMode,ProcessID, ExitCode | Sort-Object Name | Format-Table 
            Pause 
            CheckHost         
          } 
         
        9 { #USB Devices 
            Get-CimInstance -computer $compname Win32_USBControllerDevice | %{($_.Dependent)} | Select-Object Caption, Manufacturer, DeviceID | Format-List 
            Pause 
            CheckHost           
          } 
           
        10 { #Uptime 
            $wmi = Get-CimInstance -computer $compname Win32_OperatingSystem 
        ...
        11 { #Disk Info 
            $wmi = Get-CimInstance -computer $compname Win32_logicaldisk 
        ...
        12 { #Memory Info 
            $wmi = Get-CimInstance -computer $compname Win32_PhysicalMemory 
            foreach($device in $wmi){ 
        ...
        13 { #Processor Info 
            Get-CimInstance -computer $compname Win32_Processor | Format-List Caption,Name,Manufacturer,ProcessorId,NumberOfCores,AddressWidth   
            Pause 
            CheckHost 
          } 
        14 { #Monitor Info 
