#No more questad - Ivan 23/11/2017
...
# $_eventsNumReboots7Days = ($_eventsReboots7Days | Measure-Object ).Count
# $_eventsNumErrors7Days = ($_eventsErrors7Days | Measure-Object ).Count
# $_eventsNumWarnings7Days = ($_eventsWarnings7Days | Measure-Object ).Count

# $_eventsReboots24H = $_eventsReboots7Days | Where-Object { $_.TimeWritten -gt $_last24H }
# $_eventsErrors24H = $_eventsErrors7Days | Where-Object { $_.TimeWritten -gt $_last24H }
# $_eventsWarnings24H = $_eventsWarnings7Days | Where-Object { $_.TimeWritten -gt $_last24H }

# $_eventsNumReboots24H = ($_eventsReboots24H | Measure-Object ).Count
# $_eventsNumErrors24H = ($_eventsErrors24H | Measure-Object ).Count
# $_eventsNumWarnings24H = ($_eventsWarnings24H | Measure-Object ).Count
...
$Computers = @()
Get-ADComputer -Filter {(OperatingSystem -like "*windows*server*") -and (Enabled -eq "True") -and (name -ne $localName)} | ForEach-Object {$Computers += $_.Name}
