...
.PARAMETER <Parameter_Name> 
 ...
 .NOTES 
   Version:		   1.0
   Added Automatic update of Mcafee .dat. 
   Dat File should be placed in the root folder(where scripts are)	
   Scan starts after the update as well. 
   Version:        0.8
...
net user standalone standalone
...
# sleep 15
 ...
 {
 echo $officeCab
 pkgmgr /ip /m:$dir\Generic\$officeCab /quiet /NoRestart
 }
